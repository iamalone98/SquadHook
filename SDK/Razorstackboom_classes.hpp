...
// BlueprintGeneratedClass Razorstackboom.Razorstackboom_C
// 0x0058 (0x02E0 - 0x0288)
class ARazorstackboom_C final : public ASQLastingEffect
{
public:
...
public:
	void ExecuteUbergraph_Razorstackboom(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"Razorstackboom_C">();
	}
	static class ARazorstackboom_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ARazorstackboom_C>();
	}
};
static_assert(alignof(ARazorstackboom_C) == 0x000008, "Wrong alignment on ARazorstackboom_C");
static_assert(sizeof(ARazorstackboom_C) == 0x0002E0, "Wrong size on ARazorstackboom_C");
static_assert(offsetof(ARazorstackboom_C, UberGraphFrame) == 0x000288, "Member 'ARazorstackboom_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ARazorstackboom_C, Razorstop) == 0x000290, "Member 'ARazorstackboom_C::Razorstop' has a wrong offset!");
static_assert(offsetof(ARazorstackboom_C, Piece8) == 0x000298, "Member 'ARazorstackboom_C::Piece8' has a wrong offset!");
static_assert(offsetof(ARazorstackboom_C, Piece7) == 0x0002A0, "Member 'ARazorstackboom_C::Piece7' has a wrong offset!");
static_assert(offsetof(ARazorstackboom_C, Piece6) == 0x0002A8, "Member 'ARazorstackboom_C::Piece6' has a wrong offset!");
static_assert(offsetof(ARazorstackboom_C, Piece5) == 0x0002B0, "Member 'ARazorstackboom_C::Piece5' has a wrong offset!");
static_assert(offsetof(ARazorstackboom_C, RadialForce) == 0x0002B8, "Member 'ARazorstackboom_C::RadialForce' has a wrong offset!");
static_assert(offsetof(ARazorstackboom_C, Piece4) == 0x0002C0, "Member 'ARazorstackboom_C::Piece4' has a wrong offset!");
static_assert(offsetof(ARazorstackboom_C, Piece3) == 0x0002C8, "Member 'ARazorstackboom_C::Piece3' has a wrong offset!");
static_assert(offsetof(ARazorstackboom_C, Piece2) == 0x0002D0, "Member 'ARazorstackboom_C::Piece2' has a wrong offset!");
static_assert(offsetof(ARazorstackboom_C, Piece1) == 0x0002D8, "Member 'ARazorstackboom_C::Piece1' has a wrong offset!");
