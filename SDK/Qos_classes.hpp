...
{
public:
	uint8                                         Pad_21AD[0x38];                                    // 0x02B8(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AQosBeaconClient) == 0x0002F0, "Wrong size on AQosBeaconClient");
...
{
public:
	uint8                                         Pad_21AE[0x10];                                    // 0x0250(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AQosBeaconHost) == 0x000260, "Wrong size on AQosBeaconHost");
...
{
public:
	uint8                                         Pad_21AF[0x20];                                    // 0x0028(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_21B0[0x6];                                     // 0x004A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FDatacenterQosInstance>         Datacenters;                                       // 0x0050(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
	uint8                                         Pad_21B1[0x20];                                    // 0x0060(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_21B2[0x7];                                     // 0x0061(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_21B3[0x7];                                     // 0x0089(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 SelectedRegionId;                                  // 0x0090(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_21B4[0x20];                                    // 0x00A0(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
