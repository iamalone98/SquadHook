...
public:
	...
	uint8                                         Pad_25CF[0xA4];                                    // 0x033C(0x00A4)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	FMulticastInlineDelegateProperty_             OnSharedWorldDataUpdated;                          // 0x02B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnAlignmentTransformsUpdated;                      // 0x02C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AMagicLeapSharedWorldGameState) == 0x0002D8, "Wrong size on AMagicLeapSharedWorldGameState");
static_assert(offsetof(AMagicLeapSharedWorldGameState, SharedWorldData) == 0x000298, "Member 'AMagicLeapSharedWorldGameState::SharedWorldData' has a wrong offset!");
static_assert(offsetof(AMagicLeapSharedWorldGameState, AlignmentTransforms) == 0x0002A8, "Member 'AMagicLeapSharedWorldGameState::AlignmentTransforms' has a wrong offset!");
static_assert(offsetof(AMagicLeapSharedWorldGameState, OnSharedWorldDataUpdated) == 0x0002B8, "Member 'AMagicLeapSharedWorldGameState::OnSharedWorldDataUpdated' has a wrong offset!");
static_assert(offsetof(AMagicLeapSharedWorldGameState, OnAlignmentTransformsUpdated) == 0x0002C8, "Member 'AMagicLeapSharedWorldGameState::OnAlignmentTransformsUpdated' has a wrong offset!");
...
{
public:
	uint8                                         Pad_25D0[0x18];                                    // 0x0578(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AMagicLeapSharedWorldPlayerController) == 0x000590, "Wrong size on AMagicLeapSharedWorldPlayerController");
