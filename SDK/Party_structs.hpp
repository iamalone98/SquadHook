...
{
public:
	uint8                                         Pad_21B5[0x18];                                    // 0x0000(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_21BA[0x37];                                    // 0x0141(0x0037)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FPartyMemberRepData) == 0x000008, "Wrong alignment on FPartyMemberRepData");
static_assert(sizeof(FPartyMemberRepData) == 0x000178, "Wrong size on FPartyMemberRepData");
static_assert(offsetof(FPartyMemberRepData, Platform) == 0x000020, "Member 'FPartyMemberRepData::Platform' has a wrong offset!");
static_assert(offsetof(FPartyMemberRepData, PlatformUniqueId) == 0x0000A8, "Member 'FPartyMemberRepData::PlatformUniqueId' has a wrong offset!");
static_assert(offsetof(FPartyMemberRepData, PlatformSessionId) == 0x000100, "Member 'FPartyMemberRepData::PlatformSessionId' has a wrong offset!");
static_assert(offsetof(FPartyMemberRepData, CrossplayPreference) == 0x000140, "Member 'FPartyMemberRepData::CrossplayPreference' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_21BB[0x10];                                    // 0x0008(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class USocialChatChannel*>             ListenChannels;                                    // 0x0018(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_21BC[0x18];                                    // 0x0028(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_21BD[0x8];                                     // 0x0018(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPartyPrivacySettings                  PrivacySettings;                                   // 0x0020(0x0003)(NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_21BE[0x35];                                    // 0x0023(0x0035)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_21BF[0x18];                                    // 0x0068(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
