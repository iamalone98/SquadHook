...
public:
	...
	uint8                                         Pad_25B4[0x2];                                     // 0x020E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_25B5[0xF0];                                    // 0x02C0(0x00F0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_25C8[0x7];                                     // 0x0239(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(AMagicLeapARPinInfoActorBase, PinId) == 0x000228, "Member 'AMagicLeapARPinInfoActorBase::PinId' has a wrong offset!");
static_assert(offsetof(AMagicLeapARPinInfoActorBase, bVisibilityOverride) == 0x000238, "Member 'AMagicLeapARPinInfoActorBase::bVisibilityOverride' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_25C9[0x7];                                     // 0x0229(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<struct FGuid, class AMagicLeapARPinInfoActorBase*> AllInfoActors;                                     // 0x0230(0x0050)(NativeAccessSpecifierPrivate)
	uint8                                         Pad_25CA[0x8];                                     // 0x0280(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AMagicLeapARPinRenderer) == 0x000290, "Wrong size on AMagicLeapARPinRenderer");
static_assert(offsetof(AMagicLeapARPinRenderer, bInfoActorsVisibilityOverride) == 0x000228, "Member 'AMagicLeapARPinRenderer::bInfoActorsVisibilityOverride' has a wrong offset!");
static_assert(offsetof(AMagicLeapARPinRenderer, AllInfoActors) == 0x000230, "Member 'AMagicLeapARPinRenderer::AllInfoActors' has a wrong offset!");
static_assert(offsetof(AMagicLeapARPinRenderer, ClassToSpawn) == 0x000288, "Member 'AMagicLeapARPinRenderer::ClassToSpawn' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_25CB[0x8];                                     // 0x0038(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_25CC[0xF];                                     // 0x00A1(0x000F)(Fixing Struct Size After Last Property [ Dumper-7 ])
