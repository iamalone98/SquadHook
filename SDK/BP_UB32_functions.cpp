...
#include "BP_UB32_classes.hpp"
#include "BP_UB32_parameters.hpp"
...
void ABP_UB32_C::ExecuteUbergraph_BP_UB32(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_UB32_C", "ExecuteUbergraph_BP_UB32");

	Params::BP_UB32_C_ExecuteUbergraph_BP_UB32 Parms{};
...
void ABP_UB32_C::SoldierLeavesVehicle(class ASQSoldier* Soldier)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_UB32_C", "SoldierLeavesVehicle");

	Params::BP_UB32_C_SoldierLeavesVehicle Parms{};
...
void ABP_UB32_C::SoldierEntersVehicle(class ASQSoldier* Soldier)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_UB32_C", "SoldierEntersVehicle");

	Params::BP_UB32_C_SoldierEntersVehicle Parms{};
...
void ABP_UB32_C::BlueprintOnFire(const struct FVector& Origin)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_UB32_C", "BlueprintOnFire");

	Params::BP_UB32_C_BlueprintOnFire Parms{};
...
void ABP_UB32_C::PlayAnimations(class UAnimMontage* TripodAnim, class UAnimMontage* WeaponAnim, class UAnimMontage* SoldierAnim, class ASQSoldier* Soldier, float* TripodAnimTime, float* WeaponAnimTime, float* SoldierAnimTime)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_UB32_C", "PlayAnimations");

	Params::BP_UB32_C_PlayAnimations Parms{};
...
void ABP_UB32_C::StopAnimations(class ASQSoldier* Soldier)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_UB32_C", "StopAnimations");

	Params::BP_UB32_C_StopAnimations Parms{};
...
void ABP_UB32_C::ResumeAnimations(class UAnimMontage* TripodAnim, class UAnimMontage* WeaponAnim, class UAnimMontage* SoldierAnim)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_UB32_C", "ResumeAnimations");

	Params::BP_UB32_C_ResumeAnimations Parms{};
