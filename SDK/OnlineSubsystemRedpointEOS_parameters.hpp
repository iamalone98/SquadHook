...
{
public:
	struct FEOSUserInterface_CandidateEOSAccount  SelectedCandidate;                                 // 0x0000(0x0018)(Parm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(EOSUserInterface_SelectEOSAccount_Context_SelectCandidate) == 0x000018, "Wrong size on EOSUserInterface_SelectEOSAccount_Context_SelectCandidate");
