...
// (Native, Public, BlueprintCallable)
// Parameters:
// TArray<struct FEOSUserInterface_CandidateEOSAccount>Param_SelectedCandidates                               (Parm, ZeroConstructor, NativeAccessSpecifierPublic)

void UEOSUserInterface_LinkEOSAccountsAgainstCrossPlatform_Context::SelectedCandidates(const TArray<struct FEOSUserInterface_CandidateEOSAccount>& Param_SelectedCandidates)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_SelectedCandidates = std::move(Param_SelectedCandidates);
