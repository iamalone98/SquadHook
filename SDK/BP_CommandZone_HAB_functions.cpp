...
#include "BP_CommandZone_HAB_classes.hpp"
#include "BP_CommandZone_HAB_parameters.hpp"
...
void ABP_CommandZone_HAB_C::ExecuteUbergraph_BP_CommandZone_HAB(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_CommandZone_HAB_C", "ExecuteUbergraph_BP_CommandZone_HAB");

	Params::BP_CommandZone_HAB_C_ExecuteUbergraph_BP_CommandZone_HAB Parms{};
...
void ABP_CommandZone_HAB_C::ReceiveDestroyed()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_CommandZone_HAB_C", "ReceiveDestroyed");
...
void ABP_CommandZone_HAB_C::Can_Allow_Actions(bool* Allow_Actions)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_CommandZone_HAB_C", "Can Allow Actions");

	Params::BP_CommandZone_HAB_C_Can_Allow_Actions Parms{};
