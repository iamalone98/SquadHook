...
#include "W_InteractableItem_VehicleRepair_classes.hpp"
#include "W_InteractableItem_VehicleRepair_parameters.hpp"
...
void UW_InteractableItem_VehicleRepair_C::ExecuteUbergraph_W_InteractableItem_VehicleRepair(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("W_InteractableItem_VehicleRepair_C", "ExecuteUbergraph_W_InteractableItem_VehicleRepair");

	Params::W_InteractableItem_VehicleRepair_C_ExecuteUbergraph_W_InteractableItem_VehicleRepair Parms{};
...
void UW_InteractableItem_VehicleRepair_C::Format_Text()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("W_InteractableItem_VehicleRepair_C", "Format Text");
...
void UW_InteractableItem_VehicleRepair_C::Update_Vehicle_Health()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("W_InteractableItem_VehicleRepair_C", "Update Vehicle Health");
...
void UW_InteractableItem_VehicleRepair_C::Get_Format_Box(class UHorizontalBox** Param_FormatBox)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("W_InteractableItem_VehicleRepair_C", "Get Format Box");

	Params::W_InteractableItem_VehicleRepair_C_Get_Format_Box Parms{};
...
void UW_InteractableItem_VehicleRepair_C::Set_Main_Health(class ASQVehicle* Vehicle, bool* Limit_Reached, bool* Max_Health)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("W_InteractableItem_VehicleRepair_C", "Set Main Health");

	Params::W_InteractableItem_VehicleRepair_C_Set_Main_Health Parms{};
