...
// BlueprintGeneratedClass BP_BTR80_INS_PKT.BP_BTR80_INS_PKT_C
// 0x0070 (0x0C10 - 0x0BA0)
class ABP_BTR80_INS_PKT_C final : public ASQVehicleWeapon
{
public:
	...
	uint8                                         Pad_4E5E[0x4];                                     // 0x0BBC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	void ExecuteUbergraph_BP_BTR80_INS_PKT(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BP_BTR80_INS_PKT_C">();
	}
	static class ABP_BTR80_INS_PKT_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_BTR80_INS_PKT_C>();
	}
};
static_assert(alignof(ABP_BTR80_INS_PKT_C) == 0x000010, "Wrong alignment on ABP_BTR80_INS_PKT_C");
static_assert(sizeof(ABP_BTR80_INS_PKT_C) == 0x000C10, "Wrong size on ABP_BTR80_INS_PKT_C");
static_assert(offsetof(ABP_BTR80_INS_PKT_C, UberGraphFrame) == 0x000BA0, "Member 'ABP_BTR80_INS_PKT_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABP_BTR80_INS_PKT_C, SQTemperature) == 0x000BA8, "Member 'ABP_BTR80_INS_PKT_C::SQTemperature' has a wrong offset!");
static_assert(offsetof(ABP_BTR80_INS_PKT_C, ShutdownTemp) == 0x000BB0, "Member 'ABP_BTR80_INS_PKT_C::ShutdownTemp' has a wrong offset!");
static_assert(offsetof(ABP_BTR80_INS_PKT_C, OverheatEffectTrigger_1) == 0x000BB4, "Member 'ABP_BTR80_INS_PKT_C::OverheatEffectTrigger_1' has a wrong offset!");
static_assert(offsetof(ABP_BTR80_INS_PKT_C, OverheatEffectTrigger_2) == 0x000BB8, "Member 'ABP_BTR80_INS_PKT_C::OverheatEffectTrigger_2' has a wrong offset!");
static_assert(offsetof(ABP_BTR80_INS_PKT_C, Overheat_1_Effect) == 0x000BC0, "Member 'ABP_BTR80_INS_PKT_C::Overheat_1_Effect' has a wrong offset!");
static_assert(offsetof(ABP_BTR80_INS_PKT_C, Overheat_2_Effect) == 0x000BC8, "Member 'ABP_BTR80_INS_PKT_C::Overheat_2_Effect' has a wrong offset!");
static_assert(offsetof(ABP_BTR80_INS_PKT_C, Overheat_3_Effect) == 0x000BD0, "Member 'ABP_BTR80_INS_PKT_C::Overheat_3_Effect' has a wrong offset!");
static_assert(offsetof(ABP_BTR80_INS_PKT_C, Overheat_1_Sound) == 0x000BD8, "Member 'ABP_BTR80_INS_PKT_C::Overheat_1_Sound' has a wrong offset!");
static_assert(offsetof(ABP_BTR80_INS_PKT_C, Overheat_2_Sound) == 0x000BE0, "Member 'ABP_BTR80_INS_PKT_C::Overheat_2_Sound' has a wrong offset!");
static_assert(offsetof(ABP_BTR80_INS_PKT_C, SoundTest) == 0x000BE8, "Member 'ABP_BTR80_INS_PKT_C::SoundTest' has a wrong offset!");
static_assert(offsetof(ABP_BTR80_INS_PKT_C, Overheat_3_Sound) == 0x000BF0, "Member 'ABP_BTR80_INS_PKT_C::Overheat_3_Sound' has a wrong offset!");
static_assert(offsetof(ABP_BTR80_INS_PKT_C, Mesh1PReturnSection) == 0x000BF8, "Member 'ABP_BTR80_INS_PKT_C::Mesh1PReturnSection' has a wrong offset!");
static_assert(offsetof(ABP_BTR80_INS_PKT_C, Mesh3PReturnSection) == 0x000C00, "Member 'ABP_BTR80_INS_PKT_C::Mesh3PReturnSection' has a wrong offset!");
static_assert(offsetof(ABP_BTR80_INS_PKT_C, SoldierMeshReturnSection) == 0x000C08, "Member 'ABP_BTR80_INS_PKT_C::SoldierMeshReturnSection' has a wrong offset!");
