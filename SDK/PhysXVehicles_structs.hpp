...
{
public:
	uint8                                         Pad_1686[0x18];                                    // 0x00C8(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_1687[0x4];                                     // 0x000C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_1688[0x10];                                    // 0x0770(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_1689[0x3];                                     // 0x001D(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_168A[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(FVehicleTransmissionData) == 0x000040, "Wrong size on FVehicleTransmissionData");
...
static_assert(offsetof(FVehicleTransmissionData, BackwardGears) == 0x000020, "Member 'FVehicleTransmissionData::BackwardGears' has a wrong offset!");
static_assert(offsetof(FVehicleTransmissionData, ReverseGearRatio) == 0x000030, "Member 'FVehicleTransmissionData::ReverseGearRatio' has a wrong offset!");
static_assert(offsetof(FVehicleTransmissionData, NeutralGearUpRatio) == 0x000034, "Member 'FVehicleTransmissionData::NeutralGearUpRatio' has a wrong offset!");
static_assert(offsetof(FVehicleTransmissionData, NeutralGearDownRatio) == 0x000038, "Member 'FVehicleTransmissionData::NeutralGearDownRatio' has a wrong offset!");
static_assert(offsetof(FVehicleTransmissionData, ClutchStrength) == 0x00003C, "Member 'FVehicleTransmissionData::ClutchStrength' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_168B[0x4];                                     // 0x009C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
